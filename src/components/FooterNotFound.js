...
import "./FooterNotFound.css";

export default class FooterNotFound extends Component {
  render() {
    return (
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-2 col-md-4 col-12 mt-4 pt-2">
                ...
                <ul className="list-unstyled footerListNotFound mt-4">
                  <li className="pb-2">
              ...
              <div className="col-lg-4 col-md-4 col-12 mt-4">
                <ul className="list-unstyled footerListNotFound">
            ...
            <div className="row">
              <div className="col-lg-10">
                <ul className="list-unstyled">
                  <li className="list-inline-item">
                    <a href="#" className="me-3 textInfoNotFound">
                      Yasal
                    </a>
                  </li>
                  <li className="list-inline-item">
                  ...
                  <li className="list-inline-item">
                    <a href="#" className="textInfoNotFound">
                      Reklamlar Hakkında{" "}
                    </a>
                  </li>
                </ul>
